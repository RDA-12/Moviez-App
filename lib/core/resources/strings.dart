...
const kNowPlaying = "Now Playing";
const kUpcomingMovies = "Upcoming Movies";
const kPopularMovies = "Popular Movies";
const kTopMovies = "Top Movies";
const kBoxOfficeMovies = "Box Office Movies";
const kDetail = "Detail";
const kAddToFavorite = "Add to favorite";
const kDeleteFromFavorite = "Delete from favorite";
const kAddToWatchlist = "Add to watchlist";
const kDeleteFromWatchlist = "Delete from watchlist";
const kMovieSuccessfullyAddedToFavorite =
    "Movie successfully added to favorite";
const kMovieSuccessfullyAddedToWatchlist =
    "Movie successfully added to watchlist";
const kMovieSuccessfullyDeletedFromFavorite =
    "Movie successfully deleted from favorite";
